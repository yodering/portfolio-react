  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden p-6 max-w-2xl mx-auto opacity-0 animate-fade-in">
      ...
      <p className="text-gray-600 mb-4">
        student @ davidson college with an interest in creation  
      </p>
      <p className="text-gray-600 mb-4">
        i enjoy making web apps and editing videos
      </p>
      <div className="mt-6">
        <h3 className="text-xl font-semibold text-gray-800 mb-2">skills</h3>
        <div className="flex flex-wrap gap-2">
          {['JavaScript', 'React', 'Node.js', 'Python', 'Git', 'HTML','CSS', 'After Effects', 'Premiere Pro'].map((skill, index) => (
